...
if __name__ == "__main__":
    ...
    # set initial conditions and propagate sat
    state0 = [7000,0.01,58.0,0.0,0.0,0.0] # a (km),e,i,LAN,w,M (angles in degrees)
    ...
    #sat2.prop.add_maneuver(target=sat1,maneuver_type='rendezvous',dur=5.0,) # currently in progress
